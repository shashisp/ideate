...
def addhack(request):
    ...
    return render_to_response('hack_form.html', args)



def get_hacks(request):
    x = idea.objects.all()
    context = { 'x' : x }
    return render_to_response(request, 'hacks.html', context)

def get_teams(request):
    y = idea.objects.all()
    context = { 'y' : y }
    return render_to_response(request, 'teams.html', context)